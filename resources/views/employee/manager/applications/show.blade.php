                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        ...
                        @else
                            <div>
                                <p class="text-xs text-slate-400 font-semibold uppercase tracking-wider">Last Name</p>
                                <p class="text-slate-900 font-medium mt-0.5">{{ $application->corp_owner_lname ?? '—' }}
                                </p>
                            </div>
                            <div>
                                <p class="text-xs text-slate-400 font-semibold uppercase tracking-wider">First Name</p>
                                <p class="text-slate-900 font-medium mt-0.5">{{ $application->corp_owner_fname ?? '—' }}
                                </p>
                            </div>
                            <div>
                                <p class="text-xs text-slate-400 font-semibold uppercase tracking-wider">Middle Name</p>
                                <p class="text-slate-900 font-medium mt-0.5">{{ $application->corp_owner_mname ?? '—' }}
                                </p>
                            </div>
                            <div>
                                <p class="text-xs text-slate-400 font-semibold uppercase tracking-wider">Corporation Type
                                </p>
