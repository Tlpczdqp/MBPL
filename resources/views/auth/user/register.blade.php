...
@section('content')
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-sm text-slate-500 mt-1">Join to apply for business permits online</p>
    </div>
    ...
    <div class="relative my-6">
        ...
        <div class="relative flex justify-center text-xs text-slate-400 uppercase tracking-wider">
            <span class="bg-white px-3">Or sign up with</span>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-3">
        <a href="{{ route('auth.google') }}"
           class="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border
                  border-slate-300 bg-white text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
    ...
    <p class="text-center text-sm text-slate-500 mt-6">
        ...
        <a href="{{ route('user.login') }}" class="text-blue-600 font-semibold hover:underline">
            Sign in
        </a>
    </p>
